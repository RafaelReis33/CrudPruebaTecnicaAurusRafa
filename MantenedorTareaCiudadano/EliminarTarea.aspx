<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EliminarTarea.aspx.cs"
    Inherits="SistemaEastview.MantenedorTareaCiudadano.EliminarTarea" %>
                                ...
                                <div class="col-sm-12">
                                    <div class="panel panel-warning">
                                        <div class="panel-heading">
                                            <h3 style="margin-left: 10%; margin-right: 20%;">
                                                Eliminar Tarea</h3>
                                        </div>
                                        <div class="panel-body" style="margin-left: 10%; margin-right: 20%;">
                                            ...
                                            <div class="table-responsive">
                                                <div class="form-group">
                                                    <label>
                                                        Desea eliminar la tarea del ciudadano(a):
                                                        <asp:Label runat="server" ID="lblCiudadano"></asp:Label>?</label>
                                                </div>
                                                <div class="mt-3">
                                                    <asp:LinkButton runat="server" ID="btnEliminarCiudadano" type="submit" class="btn btn-danger"
                                                        OnClick="btnEliminarCiudadano_Click">Eliminar Tarea</asp:LinkButton>
